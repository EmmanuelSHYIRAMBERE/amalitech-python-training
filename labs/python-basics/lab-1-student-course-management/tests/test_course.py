...
class TestCourse:
    def test_course_attributes(self, course: Course) -> None:
    ...
    def test_add_student(self, course: Course, undergrad: UndergraduateStudent) -> None:
        assert course.add_student(undergrad) is True
        assert course.current_enrollment == 1

    def test_add_duplicate_student(
        self, course: Course, undergrad: UndergraduateStudent
    ) -> None:
    ...
    def test_get_student_list_returns_copy(
        self, course: Course, undergrad: UndergraduateStudent
    ) -> None:
        course.add_student(undergrad)
